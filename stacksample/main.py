...
def train_all_models(
    ...
    n_estimators: int = Option(
        100, "-n", "--n-estimators", help="Sets the number of estimators. Default = 100"
    ),
    n_jobs: int = Option(
        cpu_count(),
    ...
    random_forest_save_path: Optional[Path] = Option(
        None,
        help="The path for saving the random forest model if saving the model. Default = None",
    ),
